...
---
{/* In the Lessons should resize images some are too big */}

## Lessons

The MakeCode Arcade platform already include several lessons and examples, but we also have our own!

### 2D Adventure
![2D Adventure](pathname:///img/resources/makecode_arcade/ma_1.gif)
...
### Space Shooter
![Space shooter](pathname:///img/resources/makecode_arcade/ma_2.gif)

Shoot them all!

The lessons include presentations, PDFs, and videos.
...
### Edge Connectors
<img src="/img/resources/makecode_arcade/ma_3.png" alt="Edge connectors" style={{ width: "50%" }} />

Let’s play with colors using the PINs

<Button
  style={{ margin: "10px" }}
  label="Edge Connectors"
  link="/docs/resources/lessons/edge-connectors"
/>

### Analog vs Digital

<img src="/img/resources/makecode_arcade/ma_4.png" alt="Analog vs digital" style={{ width: "50%" }} />
...
<img src="/img/resources/makecode_arcade/ma_5.png" alt="LED ring" style={{ width: "50%" }} />
...
### Sensing the World-Motion!
<img src="/img/resources/makecode_arcade/ma_6.gif" alt="Motion sensor" style={{ width: "50%" }} />

Add physical movements to your game!

<Button
  style={{ margin: "10px" }}
  label="Motion Sensor"
  link="/docs/resources/lessons/sensing-the-world-motion"
/>

### Sensing the World-Light!

<img src="/img/resources/makecode_arcade/ma_7.gif" alt="Light sensor" style={{ width: "50%" }} />

Connect your projects with lights.

<Button
  style={{ margin: "10px" }}
  label="Light Sensor"
  link="/docs/resources/lessons/sensing-the-world-light"
/>

### Sensing the World-Sound!

<img src="/img/resources/makecode_arcade/ma_8.gif" alt="Sound sensor" style={{ width: "50%" }} />

Connect your projects with your voice.

<Button
  style={{ margin: "10px" }}
  label="Sound Sensor"
  link="/docs/resources/lessons/sensing-the-world-sound"
/>