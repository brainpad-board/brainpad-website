...
<Zoom>
<img alt="Main"  width="75%" src="/img/catalog/duestem-front.png" />
</Zoom>

  <table>
   <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/duestem-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/duestem-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/duestem-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/duestem-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Complete All-in-One STEM Solution**</p>
</div>
...
📄[Schematics](pathname:///sch/gdl-mcduestem-a.pdf)<br/>
🔩[3D STEP file](pathname:///3d/gdl-mcduestem-a.step)<br/>
