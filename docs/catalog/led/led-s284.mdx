...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/led-s284-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/led-s284-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/led-s284-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/led-s284-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/led-s284-back-45.png" />
      </Zoom>
    </td>
  </table>
...
<div style={{ textAlign: "center" }}>
<Zoom>
<img alt="Format" width="80%" src="/img/catalog/led-s284-format.png" />
</Zoom>
...
📄[Schematics](pathname:///sch/gdl-lleds284-b.pdf)<br/>
🔩[3D STEP file](pathname:///3d/gdl-lleds284-b.step)<br/>
...
| -------------- | --------------- | ------ |
| LED S284-Count | GDL-LLEDS284C-B | $00.00 |
| LED S284-Time  | GDL-LLEDS284T-B | $00.00 |
