...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/spectrum-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/spectrum-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/spectrum-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/spectrum-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/spectrum-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Spectrum Module**</p>
...
| ----------- | ------------- | ------ |
| Spectrum       | GDL-SOSPECTRUM-A | $00.00 |
