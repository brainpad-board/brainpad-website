...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/codec-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/codec-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/codec-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/codec-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/codec-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Codec Module**</p>
...
• MP3/WAV/MIDI/OGC Format<br/>
• 57x47mm Overall Dimension<br/>

</td><td width='50%'>
**Resources**

📄[Schematics](pathname:///sch/gdl-socodec-a.pdf)<br/>
🔩[3D STEP file](pathname:///3d/gdl-socodec-a.step)<br/>
