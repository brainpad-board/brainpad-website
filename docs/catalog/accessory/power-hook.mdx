...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/power-hook-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/power-hook-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/power-hook-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/power-hook-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/power-hook-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Battery Power Module**</p>
</div>
...
📄[Schematics](pathname:///sch/gdl-segas-a.pdf)<br/>
🔩[3D STEP file](pathname:///3d/gdl-segas-a.step)<br/>
...
| ----------- | ----------- | ------ |
| Power Hook  | GDL-AXPOWERHOOK-A | $00.00 |
