...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/dio-x12-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/dio-x12-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/dio-x12-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/dio-x12-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/dio-x12-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**12 Input-Output Module**</p>
