...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/dueclick-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/dueclick-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/dueclick-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/dueclick-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/dueclick-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**MikroBus Compatible Click Module**</p>
</div>
...
| ----------- | ----------- | ------ |
| DueClick  | GDL-AXDUECLICK-A | $00.00 |
