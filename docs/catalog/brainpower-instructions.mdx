# BrainPower Assembly Instructions
...
![BrainPower attach battery](pathname:///img/catalog/brainpower_assembly/bpa_1.gif)

Remove the protective cover on top of the 5 screw posts.

![Removing protective cover](pathname:///img/catalog/brainpower_assembly/bpa_2.gif)

Position the BrainPad Pulse (or other compatible board) holes over the 5 screw posts located at the bottom of the BrainPower base. Place 5 screws into the posts, but don’t tighten down until all the screws are in position, then tighten down.

![Screwing in Pulse](pathname:///img/catalog/brainpower_assembly/bpa_3.gif)

BrainPower works well with BrainPad Arcade V2.

![BrainPad Arcade with BrainPower](pathname:///img/catalog/brainpower_assembly/bpa_4.jpg)
...
![Wrist strap gif](pathname:///img/catalog/brainpower_assembly/bpa_5.gif)

## Assembly Complete!

![Watch assembly complete](pathname:///img/catalog/brainpower_assembly/bpa_6.png)
...
![BrainPower pins](pathname:///img/catalog/brainpower_assembly/bpa_7.png)
