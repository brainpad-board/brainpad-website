...
<Zoom>
<img alt="Main" width="75%" src="/img/catalog/load-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/load-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/load-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/load-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/load-back-45.png" />
      </Zoom>
    </td>
    
  </table>
  <p>**Load Actuator with multiple connections**</p>
  ---
</div>
...
Load Actuator with multiple connections
