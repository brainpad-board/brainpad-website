...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/gesture-h5-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/gesture-h5-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/gesture-h5-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/gesture-h5-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/gesture-h5-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Gesture Vision Sensor**</p>
</div>
...
• Gesture Camera Sensor<br/>
• 32x57mm Overall Dimension<br/>

</td><td width='50%'>
**Resources**

📄[Schematics](pathname:///sch/gdl-vigestureh5-a.pdf)<br/>
🔩[3D STEP file](pathname:///3d/gdl-vigestureh5-a.step)<br/>
...
| ----------- | --------------- | ------ |
| Gesture H5     | GDL-VIGESTUREH5-A | $00.00 |
