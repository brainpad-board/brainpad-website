...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/thermal-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/thermal-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/thermal-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/thermal-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/thermal-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Thermal Imaging Sensor**</p>
</div>
