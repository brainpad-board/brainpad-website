...
<Zoom>
<img alt="Main" width="75%" src="/img/catalog/flash-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/flash-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/flash-pencil.png" />
      </Zoom>
    </td>
     <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/flash-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/flash-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Flash Storage Module**</p>
</div>
