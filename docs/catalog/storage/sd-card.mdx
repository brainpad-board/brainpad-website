...
<Zoom>
<img alt="Main" width="75%" src="/img/catalog/sdcard-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/sdcard-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/sdcard-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/sdcard-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/sdcard-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**SD Card Storage Module**</p>
</div>
