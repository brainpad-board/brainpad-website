...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/current-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/current-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/current-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/current-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/current-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Current Sensor Module**</p>
</div>
...
| -------------- | --------------- | ------ |
| Current Sensor | GDL-SECURRENT-A | $00.00 |
