...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/barometer-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/barometer-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/barometer-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/barometer-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/barometer-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Barometric Pressure Module**</p>
</div>
...
| ----------- | ----------------- | ------ |
| Barometer   | GDL-SEBAROMETER-B | $00.00 |
