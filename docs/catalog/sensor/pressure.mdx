...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/pressure-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/pressure-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/pressure-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/pressure-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/pressure-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Pressure Sensor**</p>
...
| ----------- | ---------------- | ------ |
| Pressure    | GDL-SEPRESSURE-B | $00.00 |
