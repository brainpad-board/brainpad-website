...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/airquality-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/airquality-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/airquality-pencil.png" />
      </Zoom>
    </td>
     <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/airquality-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/airquality-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**AirQuality Sensor Module**</p>
</div>
...
| ----------- | ------------------ | ------ |
| Air Quality | GDL-SEAIRQUALITY-A | $00.00 |
