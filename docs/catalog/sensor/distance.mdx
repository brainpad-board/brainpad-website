...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/distance-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/distance-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/distance-pencil.png" />
      </Zoom>
    </td>
     <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/distance-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/distance-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Distance Sensor Module**</p>
</div>
...
| --------------- | ---------------- | ------ |
| Distance Sensor | GDL-SEDISTANCE-B | $00.00 |
