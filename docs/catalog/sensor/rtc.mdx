...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/rtc-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/rtc-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/rtc-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/rtc-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/rtc-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Realtime Clock Module**</p>
</div>
