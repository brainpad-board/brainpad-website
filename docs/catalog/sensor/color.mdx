...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/color-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/color-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/color-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/color-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/color-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Color Sensor Module**</p>
</div>
...
📄[Schematics](pathname:///sch/gdl-secolor-a.pdf)<br/>
🔩[3D STEP file](pathname:///3d/gdl-secolor-a.step)<br/>
...
| ------------ | ------------- | ------ |
| Color Sensor | GDL-SECOLOR-A | $00.00 |
