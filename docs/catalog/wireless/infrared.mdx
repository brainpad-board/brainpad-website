...
<Zoom>
<img alt="Main" width="75%" src="/img/catalog/infrared-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/infrared-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/infrared-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/infrared-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/infrared-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Infrared**</p>
...
| ----------- | --------------- | ------ |
| NRF24 Max   | GDL-WINFRARED-A | $00.00 |
