...
<Zoom>
<img alt="Main" width="75%" src="/img/catalog/nrf24-max-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/nrf24-max-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/nrf24-max-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/nrf24-max-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/nrf24-max-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**NRF24 Max**</p>
...
NRF24 Module with external antenna connector
...
• [Min Version Available](../wireless/nrf24-min)<br/>

</td><td width='50%'>
**Resources**

📄[Schematics](pathname:///sch/gdl-wnrf24-b.pdf)<br/>
🔩[3D STEP file](pathname:///3d/gdl-wnrf24-max-a.step)<br/>
...
| ----------- | --------------- | ------ |
| NRF24 Max   | GDL-WNRF24MAX-B | $00.00 |
