...
<Zoom>
<img alt="Main" width="75%" src="/img/catalog/nrf24-min-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/nrf24-min-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/nrf24-min-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/nrf24-min-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/nrf24-min-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**NRF24 Min**</p>
...
NRF24 Module with internal antenna
...
🔩[3D STEP file](pathname:///3d/gdl-wnrf24-min-a.step)<br/>
...
| ----------- | --------------- | ------ |
| NRF24 Min   | GDL-WNRF24MIN-B | $00.00 |
