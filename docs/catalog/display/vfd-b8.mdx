...
<Zoom>
<img alt="Main" width="75%" src="/img/catalog/vfd-b8-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/vfd-b8-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/vfd-b8-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/vfd-b8-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/vfd-b8-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Vacuum fluorescent display module**</p>
</div>
...
| --------------------------------- | ------------ | ------ |
| Vacuum fluorescent display module | GDL-DVFDB8-C | $00.00 |
