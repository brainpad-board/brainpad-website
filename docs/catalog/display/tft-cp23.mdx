...
<Zoom>
<img alt="Main" width="75%" src="/img/catalog/tft-cp23-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/tft-cp23-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/tft-cp23-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/tft-cp23-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/tft-cp23-back-45.png" />
      </Zoom>
    </td>
  </table>
    <p>**2.3" 320x240 color TFT Display with capacitive touch screen**</p>
</div>
...
2.3" 320x240 color TFT Display with capacitive touch screen, supporting [Graphics](../../engine/graphics) in buffered and in direct mode.
...
📄[Schematics](pathname:///sch/gdl-dtftcp23-a.pdf)<br/>
🔩[3D STEP file](pathname:///3d/gdl-dtftcp23-a.step)<br/>
...
This project uses [Arduino](../../system/arduino) software running on [DueDuino](../microcomputer/dueduino) to show values on the screen.

image

Follow the [Arduino](../../system/arduino) page instructions on loading and using the arduino tools.
...
<TabItem value="pico">Add something!</TabItem>
