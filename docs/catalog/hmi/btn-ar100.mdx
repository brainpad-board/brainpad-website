...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/btn-ar100-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/btn-ar100-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/btn-ar100-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/btn-ar100-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/btn-ar100-back-45.png" />
      </Zoom>
    </td>
  </table>
...
📄[Schematics](pathname:///sch/gdl-hibtnar100-a.pdf)<br/>
🔩[3D STEP file](pathname:///3d/gdl-hibtnar100-a.step)<br/>
...
| ----------- | ----------- | ------ |
| BTN AR100  | GDL-HIBTNAR100-A | $00.00 |
