...
<Zoom>
<img alt="Main" width="75%" src="/img/catalog/button-l-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/button-l-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/button-l-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/button-l-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/button-l-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Button Large**</p>
...
| ----------- | --------------- | ------ |
| Button L    | GDL-HIBUTTONL-A | $00.00 |
