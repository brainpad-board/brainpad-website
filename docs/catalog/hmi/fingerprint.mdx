...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/fingerprint-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/fingerprint-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/fingerprint-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/fingerprint-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/fingerprint-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Biometeric Fingerprint Module**</p>
</div>
...
• Capacitive Touch Pad<br/>
• 27x42mm Overall Dimension<br/>

</td><td width='50%'>
**Resources**

📄[Schematics](pathname:///sch/gdl-hifingerprint-a.pdf)<br/>
🔩[3D STEP file](pathname:///3d/gdl-hifingerprint-a.step)<br/>
...
| ----------- | ----------- | ------ |
| Fingerprint  | GDL-HIFINGERPRINT-A | $00.00 |
