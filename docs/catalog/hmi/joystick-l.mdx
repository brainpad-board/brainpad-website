...
<Zoom>
<img alt="Main" width="75%" src="/img/catalog/joystick-l-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/joystick-l-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/joystick-l-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/joystick-l-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/joystick-l-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Joystick Module**</p>
...
| ----------- | ----------------- | ------ |
| Joystick L  | GDL-HIJOYSTICKL-B | $00.00 |
