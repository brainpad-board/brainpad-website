...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/can-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/can-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/can-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/can-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/can-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**CAN Bus Control Module**</p>
</div>
...
📄[Schematics](pathname:///sch/gdl-cmcan-a.pdf)<br/>
🔩[3D STEP file](pathname:///3d/gdl-cmcan-a.step)<br/>
