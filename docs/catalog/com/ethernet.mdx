...
<Zoom>
<img alt="Main" width="75%" src="/img/catalog/ethernet-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/ethernet-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/ethernet-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/ethernet-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/ethernet-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Ethernet LAN Network Module**</p>
</div>
...
📄[Schematics](pathname:///sch/gdl-cmethernet-b.pdf)<br/>
🔩[3D STEP file](pathname:///3d/gdl-cmethernet-a.step)<br/>
...
| ----------- | ---------------- | ------ |
| Ethernet    | GDL-CMETHERNET-B | $00.00 |
