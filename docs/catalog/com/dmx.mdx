...
<Zoom>
<img alt="Main" width="75%" src="/img/catalog/dmx-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/dmx-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/dmx-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/dmx-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/dmx-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**Digital Multiplex Interface (DMX)**</p>
</div>
...
📄[Schematics](pathname:///sch/gdl-cmdmx-a.pdf)<br/>
🔩[3D STEP file](pathname:///3d/gdl-cmdmx-a.step)<br/>
