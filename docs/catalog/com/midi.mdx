...
<Zoom>
<img alt="Front" width="75%" src="/img/catalog/midi-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/midi-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/midi-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/midi-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/midi-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**MIDI Control Module**</p>
</div>
...
• On-board MIDI connector<br/>
• 42x42mm Overall Dimension<br/>

</td><td width='50%'>
**Resources**

📄[Schematics](pathname:///sch/gdl-cmmidi-a.pdf)<br/>
