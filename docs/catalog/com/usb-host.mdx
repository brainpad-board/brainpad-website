...
<Zoom>
<img alt="Main" width="75%" src="/img/catalog/usbhost-front.png" />
</Zoom>

  <table>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/usbhost-back.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Size" src="/img/catalog/usbhost-pencil.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Front" src="/img/catalog/usbhost-front-45.png" />
      </Zoom>
    </td>
    <td>
      <Zoom>
        <img alt="Back" src="/img/catalog/usbhost-back-45.png" />
      </Zoom>
    </td>
  </table>
  <p>**USB Host Module**</p>
...
📄[Schematics](pathname:///sch/gdl-cmusbhost-a.pdf)<br/>
🔩[3D STEP file](pathname:///3d/gdl-cmusbhost-a.step)<br/>
...
| ----------- | --------------- | ------ |
| Serial USB  | GDL-CMUSBHOST-A | $00.00 |
